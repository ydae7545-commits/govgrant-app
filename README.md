...
- **현재 단계**: **Phase 3 완료** — AI 사업계획서 도우미 백엔드+프론트 작동 검증 완료. 다음은 Phase 4 (RAG) 또는 Production 배포
...
상세 내용: [`docs/PLAN.md`](docs/PLAN.md) (마스터 플랜) · [`docs/PROGRESS.md`](docs/PROGRESS.md) (진행 상황 + 집-회사 동기화 가이드)
...
- [`docs/PLAN.md`](docs/PLAN.md) — 상용화 마스터 플랜 (Phase 0~10 상세)
- [`docs/PROGRESS.md`](docs/PROGRESS.md) — **현재 진행 상황 + 남은 과제 (가장 먼저 읽기)**
- [`docs/HANDOFF.md`](docs/HANDOFF.md) — **집 PC 에서 이어 작업하는 절차 + Claude 세션 재시작 가이드**
